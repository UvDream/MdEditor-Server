...
//@Success 200 {object} code.Response"{"code":200,"data":article.Tag,"msg":"操作成功"}"
...
func (t *TagsApi) UpdateTag(c *gin.Context) {
	...
	if tag.ID == "" {
		code.FailWithMessage("缺少tag id", c)
		return
	}
	...
	code.OkWithDetailed(data, msg, c)
}
